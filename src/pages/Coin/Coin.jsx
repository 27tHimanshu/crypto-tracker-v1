...
const Coin = () => {
  ...
  const [hisoricalData, setHistoricalData] = useState();
  ...
  useEffect(() => {
    fetchCoinData();
    fetchHistoricalData();
  }, [currency,coinId]); // Dependency should be coinId to refetch data when coinId changes

  if (coinData,hisoricalData) {
    return (
      <div className='coin'>
        ...
        <div className="coin-chart">
          <LineChart hisoricalData={hisoricalData} />
        </div>
